...
reference_result = True # Are the results we're loading from model run output file generated for reference by the analyst or new results generated by a validator?

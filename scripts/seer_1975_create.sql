CREATE TABLE seer${fn} (
	...
	"Tumor_marker_1_(1990-2003)" BOOLEAN, 
	"Tumor_marker_2_(1990-2003)" BOOLEAN, 
	"Tumor_marker_3_(1998-2003)" BOOLEAN, 
	"EOD_10_-_nodes_(1988-2003)" BOOLEAN, 
	"EOD_10_-_extent_(1988-2003)" BOOLEAN, 
	...
	"Breast_-_Adjusted_AJCC_6th_Stage_(1988-2015)" BOOLEAN, 
